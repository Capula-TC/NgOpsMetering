...
import json
import random
#from genesys.api import * #API version 3
...
#python basicPubSubV2.py --range-start 0 --range-end 9 --endpoint 'axz2zuppilfv5-ats.iot.eu-west-1.amazonaws.com' --root-ca 'C:\Users\carmichaelt\Documents\Tom C (002)\Tom C\Amazon Root CA1.txt.pem' --cert 'C:\Users\carmichaelt\Documents\Tom C (002)\Tom C\2cbab2e9e5-certificate.pem.crt' --key 'C:\Users\carmichaelt\Documents\Tom C (002)\Tom C\2cbab2e9e5-private.pem.key'
...
if __name__ == '__main__':
    ...
    if args.message:
        ...
        while (publish_count <= args.count) or (args.count == 0):
            args.message = getJsonMqttMessage()
